...
<div class="pt-12 pb-18 max-w-4xl mx-auto px-4 lg:px-8">
    ...
    <div class="mt-3">
        ...
        <div id="novo-relato" class="<?= !$isConsulta ? '' : 'hidden' ?> bg-slate-100 py-4 px-8 md:py-8 md:px-14" role="tabpanel" aria-labelledby="item-1">
            ...
            <div class="w-full mb-4 ">  
                ...
                <textarea name="descricao-relato" id="descricao-relato" class="mt-2 w-full bg-zinc-50 text-zinc-600 text-sm border border-[#6bc16a] rounded pl-3 pr-8 py-3 transition duration-300 ease focus:outline-none focus:border-[#6bc16a] hover:border-[#6bc16a] shadow-sm focus:shadow-md appearance-none" rows="4" placeholder="Descreva sua mensagem em detalhes..."></textarea>
            </div>
            ...
            <div class="w-full">
                <button class="w-full bg-[#2a895c] text-white font-semibold py-4 rounded-none rounded-tl-4xl cursor-pointer rounded-br-4xl hover:bg-[#6bc16a] transition duration-300 ease">Enviar relato</button>
            </div>
        ...
        <div id="consulta" class="<?= !$isConsulta ? 'hidden' : '' ?> bg-slate-100 py-4 px-8 md:py-8 md:px-14" role="tabpanel" aria-labelledby="item-2">
            <div>
                <label for="nome" class="text-[#2a895c] font-semibold">Número do Protocolo</label>    
                <div class="flex flex-col md:flex-row gap-2">
                    <input 
                        type="text" 
                        name="nome" 
                        id="nome" 
                        class="mt-2 w-full text-zinc-600 bg-zinc-50 text-sm border border-[#6bc16a] rounded pl-3 pr-8 py-3 transition duration-300 ease focus:outline-none focus:border-[#6bc16a] hover:border-[#6bc16a] shadow-sm focus:shadow-md appearance-none" 
                        placeholder="Insira o código recebido." 
                    />

                    <button class="mt-2 w-full md:max-w-[190px] bg-[#2a895c] text-white font-semibold py-2 rounded-none rounded-tl-4xl cursor-pointer rounded-br-4xl hover:bg-[#6bc16a] transition duration-300 ease">Verificar</button>
                </div>
            </div>
        </div>
    </div>
